...
class JmxMBeanPropertyCache {
	private static final Pattern PROPERTY_PATTERN = Pattern.compile("([^,=:\\*\\?]+)" + "=" + // Equals
			"(" + // Either
			"\"" + // Quoted
			...
			")*" + "\"" + "|" + // Or
			"[^,=:\"]*" + // Unquoted - can be empty, anything but comma,
	...
	private static Map<ObjectName, LinkedHashMap<String, String>> keyPropertiesPerBean;
	...
	public static LinkedHashMap<String, String> getKeyPropertyList(ObjectName mbeanName) {
